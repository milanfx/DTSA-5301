...
#### 1. Economic development level is negatively related to the mortality rate.
#### 2. Ontario, Quebec, and British Columbia show different level of infection rate.
#### 3. Mortality rate and infection rate are influenced by many factors, which could lead to some incorrect interpretations.

<table style="width: 900px"><tr><td bgcolor="wheat"><font color="brown" size="5"><b>
&nbsp;&nbsp;4.1 Data Bias
</b></font></td></tr></table>

#### 1. Objective bias: The data for Covid_19 depends on the local medical standards. If medical resources cannot keep up, the number of infections might not be recorded, potentially leading to a relative decrease of infection rate. On the other hand, if infection rate is high, it could lead to a low mortality rate.
